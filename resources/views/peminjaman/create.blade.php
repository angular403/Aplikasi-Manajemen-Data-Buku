        ...
        <div class="overflow-y-scroll h-64 border border-gray-300 p-4">
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                ...
                <div class="flex flex-col items-center p-4 border rounded-sm-shadow-sm">
                    @if ($buku->cover)
                    <img src="{{asset('storage'). '/'. $buku->cover}}" alt="Cover" class="w-16 h-20 object-cover mb-2" srcset="">
                    @else
                    <img src="{{asset('img/default_book.PNG')}}" alt="Cover" class="w-16 h-20 object-cover mb-2" srcset="">
                    @endif
